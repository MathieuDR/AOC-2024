defmodule Aoc2024.Solutions.Y24.Day15Test do
  ...
  #
  #     mix AoC.test --year 2024 --day 15
  #
  #     mix test test/2024/day15_test.exs
  #
  # To run the solution
  #
  #     mix AoC.run --year 2024 --day 15 --part 1
  #
  # Use sample input file:
  #
  #     # returns {:ok, "priv/input/2024/day-15-mysuffix.inp"}
  #     {:ok, path} = Input.resolve(2024, 15, "mysuffix")
  #
  # Good luck!
